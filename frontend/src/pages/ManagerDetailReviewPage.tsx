    ...
    <section className="dashboard">
      ...
      <div className="action-grid">
        {contexts.map((context) => (
          <Link className="team-context-row" key={context.team_node_id} to={`/manager-detail-review/${context.team_node_id}`}>
            <div>
